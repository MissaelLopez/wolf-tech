...
@section('content')
@include('includes.breadcrumb', [ 'breadcrumbs' => [ 'Ocio' => '/entertainment', 'Sección 1' => '' ] ])
<section class="mb-14">
    <div class="container p-5">
        <div class="flex flex-wrap justify-center mb-10">
            <div class="w-full px-4">
                <div class="text-center mx-auto">                    
                    <h2 class="font-bold text-3xl sm:text-4xl mb-4 dark:text-primary">Artículos sobre Ocio</h2>
                    <p class="text-base">
            ...
            <div class="w-full md:w-1/2 lg:w-1/3 px-4">            
               <div class="mx-auto mb-10">
                  ...
                  <div>                  
                     ...
                     <a href="/entertainment-article{{ $i + 1 }}">
